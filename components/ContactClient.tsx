...
const contactMethods = [
  { icon: Phone, title: 'Call Us Now', desc: 'Speak directly with a technician or book over the phone', value: '+1 (844) 810-0173', action: 'tel:+18448100173', label: 'Call Now', color: 'from-[#0066cc] to-[#0052a3]' },
  { icon: Mail, title: 'Email Support', desc: 'Send us your questions — we respond within 2 hours', value: 'support@frontechsecurity.com', action: 'mailto:support@frontechsecurity.com', label: 'Send Email', color: 'from-[#7c3aed] to-[#0066cc]' },
  { icon: Clock, title: 'Hours of Operation', desc: 'Available 7 days a week for your convenience', value: 'Mon–Sun, 7AM–10PM EST', action: null, label: null, color: 'from-[#22c55e] to-[#0052a3]' },
    ...
    return (
      <div className="min-h-[70vh] bg-white flex items-center justify-center px-4 py-20">
        <div className="max-w-lg w-full text-center space-y-6">
          ...
          <h1 className="text-3xl font-black text-[#1a1a1a] font-serif">Message Received!</h1>
          <p className="text-[#4a4a4a]">
            Thank you, <span className="text-[#1a1a1a] font-semibold">{form.name}</span>. A member of our team will contact you at <span className="text-[#0066cc]">{form.email}</span> within 2 business hours.
          </p>
          <div className="glow-card bg-white rounded-xl p-5 text-left space-y-2 text-sm">
            {form.phone && <p className="text-[#4a4a4a]"><span className="text-[#1a1a1a] font-semibold">Phone: </span>{form.phone}</p>}
            {form.service && <p className="text-[#4a4a4a]"><span className="text-[#1a1a1a] font-semibold">Service: </span>{form.service}</p>}
          </div>
    ...
    <div className="bg-white">
      ...
      <section className="py-20 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative">
          <span className="text-[#0066cc] text-xs font-bold uppercase tracking-widest">Get in Touch</span>
          ...
          {contactMethods.map(({ icon: Icon, title, desc, value, action, label, color }) => (
            <div key={title} className="glow-card bg-white rounded-xl p-6 flex flex-col gap-3">
              ...
              <div>
                ...
                <p className="text-[#4a4a4a] text-xs leading-relaxed mb-2">{desc}</p>
      ...
      <section className="pb-20 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-3">
            <div className="glow-card bg-white rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl bg-[#0066cc]/15 flex items-center justify-center">
                  <MessageSquare size={20} className="text-[#0066cc]" />
                </div>
                <div>
                  <h2 className="text-[#1a1a1a] font-bold font-serif text-lg">Send Us a Message</h2>
                  <p className="text-[#4a4a4a] text-xs">We respond within 2 business hours</p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-[#4a4a4a] text-xs font-semibold mb-1.5 uppercase tracking-wider">Phone Number *</label>
                  ...
                  <div>
                    <label className="block text-[#4a4a4a] text-xs font-semibold mb-1.5 uppercase tracking-wider">Service Needed</label>
                  ...
                  <div>
                    <label className="block text-[#4a4a4a] text-xs font-semibold mb-1.5 uppercase tracking-wider">Message</label>
                  ...
                  <p className="text-center text-[#4a4a4a] text-xs">
                    ...
                    <a href="tel:+18448100173" className="text-[#0066cc] font-semibold hover:underline">+1 (844) 810-0173</a>
                  </p>
                </form>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="glow-card bg-white rounded-xl p-6">
              <h3 className="text-[#1a1a1a] font-bold mb-4 font-serif">Why Call Instead of Email?</h3>
            ...
            <div className="glow-card bg-white rounded-xl p-6">
              <h3 className="text-[#1a1a1a] font-bold mb-3 font-serif">Before You Call</h3>
              <p className="text-[#4a4a4a] text-sm leading-relaxed mb-3">Have the following ready to speed things up:</p>
              <ul className="space-y-2 text-sm text-[#4a4a4a]">
                {['Your home address or zip code', 'Number of devices to install', 'Device brand/model (if known)', 'Preferred appointment date/time'].map((i) => (
                  <li key={i} className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#0066cc] mt-1.5 shrink-0" />{i}
                  </li>
                ))}
              </ul>
            </div>
            <div className="glow-card bg-white rounded-xl p-6 text-center">
              <p className="text-[#22c55e] font-bold text-sm mb-1">Average Wait Time</p>
              <p className="text-[#1a1a1a] font-black text-3xl font-serif mb-1">{'< 60 sec'}</p>
              <p className="text-[#4a4a4a] text-xs">to speak with a live technician</p>
            </div>

            {/* Physical address */}
            <div className="glow-card bg-white rounded-xl p-6">
              <h3 className="text-[#1a1a1a] font-bold mb-3 font-serif flex items-center gap-2">
                <MapPin size={16} className="text-[#f59e0b]" />
                Our Location
              </h3>
              <address className="not-italic text-[#4a4a4a] text-sm leading-relaxed mb-4">
                <span className="text-[#1a1a1a] font-semibold block mb-1">FrontechSecurity</span>
                7430 Pasito Ave<br />
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-[#0066cc] text-sm font-semibold hover:text-[#1a1a1a] transition-colors"
              >
                <MapPin size={13} />
            ...
            <div className="bg-[#0a1628] border border-[#e5e7eb] rounded-xl p-4 flex items-start gap-3">
              <ShieldCheck size={15} className="text-[#0066cc] shrink-0 mt-0.5" />
